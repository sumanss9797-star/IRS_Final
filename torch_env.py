...
class RIS_MISO_Env(gym.Env):
    ...
    def step(self, raw_action):
        ...
        # Capture individual data rates exactly like we did in the benchmark
        actual_rates, _ = self.compute_min_DownLinkRate()
        info['individual_rates'] = actual_rates.tolist()
