...
class RIS_MISO_Env(gym.Env):
    ...
    def __init__(self, 
        ...
        # print(self.action_space.sample())  # e.g. [5 7 0 0 1 6 0 3 2 5 7 7 0 4 0 3]
    ...
    def reset(self, seed=None, options=None):
        ...
        # self.H_2 = np.random.normal(0, np.sqrt(0.5), (self.Nk, self.Ns)) + 1j*np.random.normal(0, np.sqrt(0.5), (self.Nk, self.Ns))
        # self.H_3 = np.random.normal(0, np.sqrt(0.5), (self.Nk, self.Nt)) + 1j*np.random.normal(0, np.sqrt(0.5), (self.Nk, self.Nt))
        ...
        # self._rescale(actions=self.action_space.sample())
        # np.random.randint(low=0, high=self.n_actions, size=(self.action_dim,))
